...
def evaluate_guard(current_guard: str, m: RuntimeMeasurements, cfg: EmsConfig) -> GuardDecision:
    transport_ok = m.victron_heartbeat_age_s <= cfg.victron_heartbeat_timeout_s
    ...
    if soc_stale:
        return GuardDecision(GuardProfile.DEGRADED, soc_stale, transport_ok, soc_valid, 'Victron/SOC data is stale or invalid')

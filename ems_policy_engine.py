...
def read_config():
    return EmsConfig(
        ...
        battery_protect_charge_floor_w=get_float(ENT.get('battery_protect_charge_floor_w', 'input_number.ems_battery_protect_charge_floor_w'), 0.0),
        ev_min_current_a=get_int(ENT['ev_min_current_a'], 6),
        ...
        ev_hard_off_release_cycles=get_int(ENT['ev_hard_off_release_cycles'], 2),

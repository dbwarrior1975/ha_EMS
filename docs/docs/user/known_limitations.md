...
HARD_OFF debounce ja release käyttävät policy-ajojen määrää, eivät tarkkaa elapsed-aikaa. `low_pv_cycles` saturoituu eikä aiheuta yönaikaista jatkuvaa PS-julkaisua, mutta skipped tickit ja cadence vaikuttavat silti todelliseen kestoon.

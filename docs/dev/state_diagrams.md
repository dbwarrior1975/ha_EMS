...
stateDiagram-v2
    ...
    ActiveSet --> ActiveSet: RELEASE unavailable
    ActiveSet --> ActiveSet: RELEASE newest n-1 step by negative RPC
    ActiveSet --> ActiveSet: RELEASE final anchor by RPNZ deadband

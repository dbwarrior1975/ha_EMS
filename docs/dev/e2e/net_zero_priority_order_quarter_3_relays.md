...
## Phase split
1. Phase 1 (t0, t30, t60, t61, t71): activation order RELAY1 -> ADJUSTABLE(EV) -> RELAY2 ->RELAY3.
2. Phase 2 (t76, t90, t91): all-active stability, then release RELAY3->RELAY2 -> ADJUSTABLE.

...
def build_harness(project_root):
    ...
    h.set_entities({
        ...
        E['devices']['EV_CHARGER']['surplus_allowed']: True,
        E['devices']['EV_GARAGE']['surplus_allowed']: True,
        ...
        'input_number.ems_relay1_power_kw': 2600,
        'input_number.ems_relay1_nominal_absorb_w': 2600,

...
from tests.e2e_entity.net_zero_homebattery_surplus_load.scenario_steps import build_harness
from tests.e2e_entity.net_zero_homebattery_surplus_load.scenario_steps import run_steps

@pytest.mark.scenario
def test_01_baseline_to_surplus_activation(project_root):
    ...
    steps = [
        ...
        {
            'at_s': 73,
            'note': 't73 trigger point: RPC crosses EV_CHARGER threshold and dispatch activates surplus load',

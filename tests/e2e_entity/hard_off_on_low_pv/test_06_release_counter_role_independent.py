    ...
    steps = [
        {
            ...
            'set': recovery_inputs(100, 5.8),
            'expect_derived': recovery_derived(100, 5.8),
            'expect_policy': {
        ...
        },
        {
            ...
            'set': recovery_inputs(130, 5.8),
            'expect_derived': recovery_derived(130, 5.8),
            'expect_policy': {
                'ev_hard_off_active': True,
        ...
        },
        {
            ...
            'set': recovery_inputs(190, 5.8),
            'expect_derived': recovery_derived(190, 5.8),
            'expect_policy': {
                'ev_hard_off_active': True,
                'ev_hard_off_release_ready_cycles': 1,
            },
        ...
        },
        {
            ...
            'set': recovery_inputs(220, 5.8),
            'expect_derived': recovery_derived(220, 5.8),
            'expect_policy': {
                'ev_hard_off_active': True,
                'ev_hard_off_release_ready_cycles': 2,
            },
        ...
        },
        {
            ...
            'set': recovery_inputs(250, 5.8),
            'expect_derived': recovery_derived(250, 5.8),
            'expect_policy': {
                'ev_hard_off_active': False,
                'ev_hard_off_release_ready_cycles': 3,
            },
